...
@Component({
    ...
    styles: ``,
    imports: [RouterModule, CommonModule, BreadcrumbComponent, DonationCardComponent, IconQuoteComponent, ShareButtonsComponent, BlogSliderComponent, RelatedBlogsComponent, ImgPlaceholderDirective]
})
